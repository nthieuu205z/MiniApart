...
- [ ] Quy trình chạy được trên GitHub Actions, cấu hình nằm trong repo
- [ ] Có bước chạy kiểm thử **trước** bước dựng ảnh, và bước sau phụ thuộc bước trước
...
- [ ] Không có mật khẩu, khoá, hay chuỗi kết nối nào viết thẳng trong file cấu hình quy trình
