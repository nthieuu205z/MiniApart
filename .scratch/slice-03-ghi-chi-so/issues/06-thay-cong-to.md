...
- [ ] Migration thêm `chi_so_cuoi_cong_to_cu` và `chi_so_dau_cong_to_moi` vào `CHI_SO_DICH_VU`, cả hai cho phép rỗng
- [ ] Ràng buộc: hai trường đó **chỉ có giá trị khi** `co_thay_cong_to` bật, và **bắt buộc có giá trị** khi cờ đó bật. Ép bằng `CHECK` ở tầng cơ sở dữ liệu
- [ ] Giao diện chỉ hiện hai ô thêm khi người dùng bật khai báo thay công tơ
- [ ] Công thức tiêu thụ theo BR-09: `(cuối công tơ cũ − đầu kỳ) + (cuối kỳ − đầu công tơ mới)`
- [ ] Có test cho ca công tơ mới bắt đầu từ 0, và ca công tơ mới bắt đầu từ một số khác 0
- [ ] Tên test mang mã `FR-MTR-09`, `CR-004`, `BR-09`
