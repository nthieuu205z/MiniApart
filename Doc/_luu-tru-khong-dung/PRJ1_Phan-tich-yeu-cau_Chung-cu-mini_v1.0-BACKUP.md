...
## Hệ thống Quản lý và Vận hành Chung cư mini

**Môn học:** Project 1 — Bài 2: Phân tích yêu cầu
**Mã dự án:** PRJ1-CCM
**Phiên bản:** 1.0 (Baseline đề xuất)
**Ngày lập:** 20/08/2026

| Thành viên | Vai trò trong nhóm | Phần phụ trách |
|---|---|---|
| ......................... | Nhóm trưởng / Business Analyst | Mục 1, 2, 3 — Stakeholder & thu thập yêu cầu |
| ......................... | BA / Kiểm thử | Mục 4 — User story & tiêu chí chấp nhận |
| ......................... | System Analyst | Mục 5 — Đặc tả SRS |
| ......................... | Thiết kế hệ thống | Mục 6 — Mô hình hoá (UC, ERD, DFD, Activity) |

**Lịch sử phiên bản**

| Phiên bản | Ngày | Người sửa | Nội dung thay đổi |
|---|---|---|---|
| 0.1 | .../08/2026 | Nhóm | Bản nháp đầu tiên, xác định stakeholder |
| 0.5 | .../08/2026 | Nhóm | Bổ sung user story và SRS |
| 1.0 | .../08/2026 | Nhóm | Baseline sau khi review với giảng viên |
...
1. Giới thiệu
2. Xác định các bên liên quan (Stakeholder)
3. Thu thập yêu cầu (Requirement Elicitation)
4. User Story và Tiêu chí chấp nhận
5. Đặc tả yêu cầu phần mềm (SRS)
6. Mô hình hoá yêu cầu
7. Xác minh yêu cầu (Validation)
8. Quản lý yêu cầu (Requirement Management)
9. Phụ lục
...
**Ngoài phạm vi (Out of scope) — phiên bản 1.0**
...
|---|---|---|
| R1 | Slide bài giảng "Project 1 — Phân tích yêu cầu" | Khung phương pháp và cấu trúc tài liệu |
| R2 | Quyết định về giá bán lẻ điện sinh hoạt 6 bậc, áp dụng từ 10/5/2025 | Cơ sở cho quy tắc tính tiền điện bậc thang |
| R3 | Quy định về giá điện cho người thuê nhà (định mức 4 người/hộ) | Ràng buộc pháp lý khi tính tiền điện cho phòng trọ |
| R4 | Luật PCCC & CNCH 2024, Nghị định 105/2025/NĐ-CP | Cơ sở cho phân hệ quản lý hồ sơ và kiểm tra PCCC định kỳ |
| R5 | Luật Cư trú 2020 và quy định thông báo lưu trú | Cơ sở cho chức năng quản lý hồ sơ tạm trú người thuê |
| R6 | Mẫu hợp đồng thuê nhà ở phổ biến | Nguồn xác định các trường dữ liệu của thực thể Hợp đồng |
| R7 | Khảo sát 3 ứng dụng tương tự trên thị trường (xem mục 3.5.2) | Đối sánh tính năng, tránh bỏ sót yêu cầu |
...
### 2.1.1. Lớp trong — người dùng trực tiếp
...
### 2.1.2. Lớp ngoài — bị ảnh hưởng, không thao tác trực tiếp
...
### 2.1.3. Lớp ràng buộc — đặt ra quy định
...
## 2.2. Ma trận Quyền lực – Quan tâm (Power/Interest Grid)
...
> **Ghi chú về nguồn dữ liệu:** Trong khuôn khổ đồ án, nhóm **không tiếp cận được người dùng thật để phỏng vấn**. Toàn bộ dữ liệu tại mục 3.6 là **kịch bản giả định do nhóm xây dựng** dựa trên: (a) quan sát thực tế mô hình nhà trọ tại khu vực quanh trường, (b) phân tích tài liệu pháp quy và mẫu biểu có thật, (c) đối sánh các phần mềm cùng loại đang bán trên thị trường. Các con số thống kê ở mục 3.6.3 là **số liệu mô phỏng**, được đánh dấu rõ và **không dùng làm căn cứ định lượng chính thức**. Bộ câu hỏi ở mục 3.2 và 3.3 được thiết kế ở dạng sẵn sàng sử dụng, để nhóm có thể triển khai thu thập dữ liệu thật khi có điều kiện.

## 3.2. Kịch bản phỏng vấn
...
### 3.2.2. Bộ câu hỏi cho Chủ sở hữu (SH-01)
...
### 3.2.3. Bộ câu hỏi cho Quản lý toà nhà (SH-02)
...
### 3.2.4. Bộ câu hỏi cho Người thuê (SH-03) — phỏng vấn ngắn 15 phút
...
### 3.2.5. Bộ câu hỏi cho Thợ sửa chữa (SH-05)
...
## 3.3. Bảng hỏi khảo sát người thuê (Questionnaire)
...
## 3.4. Quan sát trực tiếp (Observation) — Phiếu ghi nhận
...
## 3.5. Phân tích tài liệu (Document Analysis)

### 3.5.1. Tài liệu nghiệp vụ và pháp quy
...
| D4 | **Biểu giá bán lẻ điện sinh hoạt 6 bậc** (áp dụng từ 10/5/2025) | Bậc 1 (0–50 kWh): 1.984 đ; Bậc 2 (51–100): 2.050 đ; Bậc 3 (101–200): 2.380 đ; Bậc 4 (201–300): 2.998 đ; Bậc 5 (301–400): 3.350 đ; Bậc 6 (từ 401): 3.460 đ *(chưa gồm VAT)* | Sinh BR-02b: hệ thống phải hỗ trợ chế độ tính bậc thang, biểu giá phải **cấu hình được theo thời điểm hiệu lực** vì giá điện có thể điều chỉnh nhiều lần trong năm |
...
### 3.5.2. Đối sánh sản phẩm cùng loại

| Tính năng | Phần mềm A (quản lý nhà trọ phổ thông) | Phần mềm B (thiên về app người thuê) | Phần mềm C (Excel template) | **MiniApart (đề xuất)** |
|---|---|---|---|---|
| Quản lý nhiều toà | Có | Có | Không | Có |
| Ghi chỉ số trên điện thoại | Có | Có | Không | Có |
| **Lưu ảnh công tơ kèm chỉ số** | Không | Có | Không | Có (điểm khác biệt) |
| Tính điện bậc thang theo định mức người | Một phần | Không | Không | Có (điểm khác biệt) |
| Chia tiền theo ngày khi vào/ra giữa kỳ | Không | Không | Không | Có (điểm khác biệt) |
| Cổng người thuê | Không | Có | Không | Có |
| Quản lý sự cố có vòng đời trạng thái | Một phần | Có | Không | Có |
| **Nhắc lịch kiểm tra PCCC, hạn tạm trú** | Không | Không | Không | Có (điểm khác biệt) |
| Đối chiếu công tơ tổng phát hiện thất thoát | Không | Không | Không | Có (điểm khác biệt) |
| Thanh toán online tự động | Có | Có | Không | Không (ngoài phạm vi, dùng QR) |

**Kết luận:** năm điểm khác biệt được chọn làm trọng tâm giá trị của đồ án, tập trung vào **tính minh bạch** và **tuân thủ quy định** — hai khoảng trống mà các sản phẩm hiện có chưa xử lý tốt.

## 3.6. Tổng hợp kết quả thu thập

> **LƯU Ý — Toàn bộ nội dung mục 3.6 là dữ liệu giả định (mô phỏng)** do nhóm xây dựng, không phải kết quả khảo sát thực tế. Xem ghi chú ở mục 3.1.

### 3.6.1. Phát hiện chính từ phỏng vấn chủ sở hữu và quản lý
...
### 3.6.2. Phát hiện chính từ phía người thuê
...
### 3.6.3. Kết quả bảng hỏi *(số liệu mô phỏng, n = 72)*
...
**Cách sử dụng kết quả:** các tính năng có điểm ≥ 4,0 được xếp **Must have**; từ 3,0 đến 3,9 xếp **Should have**; dưới 3,0 xếp **Could have**. Đây là căn cứ định lượng cho cột ưu tiên MoSCoW ở mục 4 và 5.

## 3.7. Danh sách yêu cầu sơ bộ
...
## EP-01 — Quản trị người dùng và phân quyền
...
## EP-02 — Danh mục toà nhà, phòng, dịch vụ
...
- Khi chủ chọn chế độ tính điện "bậc thang theo giá Nhà nước", thì hệ thống áp biểu giá 6 bậc và cho nhập định mức theo số người ở của phòng.
...
## EP-03 — Người thuê và hợp đồng thuê
...
## EP-10 — An toàn, tuân thủ và nhật ký
...
## 5.2. Vai trò và ma trận phân quyền
...
### 5.3.1. Module AUT — Xác thực và phân quyền
...
### 5.3.2. Module BLD — Toà nhà, phòng, dịch vụ
...
### 5.3.3. Module TNT — Người thuê và hợp đồng
...
### 5.3.4. Module MTR — Ghi chỉ số dịch vụ
...
### 5.3.5. Module INV — Hoá đơn và thanh toán
...
### 5.3.6. Module MNT — Sự cố và bảo trì
...
### 5.3.7. Module NTF — Thông báo và nhắc việc
...
### 5.3.8. Module POR — Cổng người thuê
...
### 5.3.10. Module SEC — An toàn, tuân thủ, nhật ký
...
## 5.4. Quy tắc nghiệp vụ (Business Rules)
...
### 5.4.2. Tính tiền dịch vụ theo chỉ số
...
Áp dụng biểu giá 6 bậc (hiệu lực từ 10/5/2025, chưa gồm VAT):

| Bậc | Sản lượng (kWh) | Đơn giá (đ/kWh) |
|---|---|---|
| 1 | 0 – 50 | 1.984 |
| 2 | 51 – 100 | 2.050 |
| 3 | 101 – 200 | 2.380 |
| 4 | 201 – 300 | 2.998 |
| 5 | 301 – 400 | 3.350 |
| 6 | từ 401 trở lên | 3.460 |

Tiền điện = tổng của (sản lượng thuộc từng bậc × đơn giá bậc đó), cộng thuế GTGT theo thuế suất cấu hình. Biểu giá phải được lưu kèm ngày hiệu lực vì Nhà nước có thể điều chỉnh nhiều lần trong năm; hoá đơn đã phát hành giữ nguyên biểu giá tại thời điểm phát hành.
...
### 5.4.4. Ràng buộc dữ liệu và vòng đời
...
### 5.4.5. Ví dụ minh hoạ tính hoá đơn
...
### 5.5.2. Khả dụng và trải nghiệm (Usability)
...
### 5.5.4. Tin cậy và an toàn dữ liệu (Reliability)
...
### 5.5.5. Khả năng bảo trì và mở rộng (Maintainability & Scalability)

| Mã | Yêu cầu |
|---|---|
| NFR-MNT-01 | Mã nguồn tổ chức theo module tương ứng các module chức năng ở mục 5.3, có tài liệu README hướng dẫn cài đặt |
...
### 5.5.6. Tương thích (Compatibility)
...
### 5.5.7. Tuân thủ pháp lý (Compliance)
...
| C-02 | Không có ngân sách mua dịch vụ trả phí; phải dùng nền tảng miễn phí hoặc gói dùng thử |
...
| A-06 | Biểu giá điện Nhà nước có thể thay đổi trong thời gian dự án | Đã xử lý bằng cơ chế biểu giá theo ngày hiệu lực |

## 5.7. Giao diện với hệ thống ngoài
...
### 6.1.1. Phân hệ quản trị và báo cáo — tác nhân Chủ sở hữu, Quản trị hệ thống

![Hình 6.1 — Biểu đồ use case phân hệ quản trị và báo cáo](diagrams/01a-usecase-chu.png)

### 6.1.2. Phân hệ vận hành — tác nhân Quản lý toà nhà, Thợ sửa chữa

![Hình 6.2 — Biểu đồ use case phân hệ vận hành](diagrams/01b-usecase-quanly.png)

### 6.1.3. Cổng người thuê — tác nhân Người thuê, Người ở cùng

![Hình 6.3 — Biểu đồ use case cổng người thuê](diagrams/01c-usecase-nguoithue.png)

### 6.1.4. Danh sách use case
...
## 6.3. Biểu đồ hoạt động (Activity Diagram)

### 6.3.1. Quy trình ghi chỉ số dịch vụ

![Hình 6.4 — Biểu đồ hoạt động: quy trình ghi chỉ số dịch vụ](diagrams/02a-activity-ghichiso.png)

### 6.3.2. Quy trình lập và phát hành hoá đơn

![Hình 6.5 — Biểu đồ hoạt động: quy trình lập và phát hành hoá đơn](diagrams/02b-activity-hoadon.png)

### 6.3.3. Quy trình tiếp nhận yêu cầu sửa chữa

![Hình 6.6 — Biểu đồ hoạt động: quy trình tiếp nhận yêu cầu sửa chữa](diagrams/03a-activity-succo-tiepnhan.png)

### 6.3.4. Quy trình xử lý và đóng yêu cầu sửa chữa

![Hình 6.7 — Biểu đồ hoạt động: quy trình xử lý và đóng yêu cầu sửa chữa](diagrams/03b-activity-succo-xuly.png)

### 6.3.5. Quy trình bàn giao khi trả phòng

![Hình 6.8 — Biểu đồ hoạt động: quy trình bàn giao khi trả phòng](diagrams/04a-activity-traphong.png)

### 6.3.6. Quy trình quyết toán tiền cọc và thanh lý hợp đồng

![Hình 6.9 — Biểu đồ hoạt động: quy trình quyết toán cọc và thanh lý hợp đồng](diagrams/04b-activity-quyettoan.png)

## 6.4. Biểu đồ luồng dữ liệu (DFD)

### 6.4.1. DFD mức 0 — Sơ đồ ngữ cảnh

![Hình 6.10 — Biểu đồ luồng dữ liệu mức 0 (sơ đồ ngữ cảnh)](diagrams/05-dfd-level0.png)

### 6.4.2. DFD mức 1 — Phân rã tiến trình

![Hình 6.11 — Biểu đồ luồng dữ liệu mức 1](diagrams/06-dfd-level1.png)

**Danh sách tiến trình mức 1**
...
## 6.5. Biểu đồ thực thể quan hệ (ERD)

![Hình 6.12 — Biểu đồ thực thể quan hệ (ERD)](diagrams/07-erd.png)

> Ảnh trong tài liệu bị thu nhỏ cho vừa khổ giấy. Bản độ phân giải cao (3168 px) nằm ở `diagrams/07-erd.png`; mã nguồn sơ đồ ở `diagrams/07-erd.mmd` để sửa lại khi cần.
...
| `NGUOI_THUE` | Cá nhân thuê hoặc ở cùng | Tách khỏi `NGUOI_DUNG` vì không phải người thuê nào cũng có tài khoản đăng nhập |
...
| `CHI_SO_DICH_VU` | Chỉ số công tơ của một phòng, một dịch vụ, một kỳ | Khoá duy nhất: (kỳ, phòng, dịch vụ). Có cờ `co_thay_cong_to` phục vụ BR-09 |
...
| `THANH_TOAN` | Một lần thu tiền | Nhiều bản ghi cho một hoá đơn → hỗ trợ thu nhiều lần; không xoá (BR-18) |
| `YEU_CAU_SUA_CHUA` | Một sự cố được báo | Có vòng đời trạng thái riêng (BR-16) |
| `ANH_DINH_KEM` | Ảnh gắn với nhiều loại đối tượng | Dùng khoá đa hình `(doi_tuong_loai, doi_tuong_id)` để dùng chung cho ảnh công tơ và ảnh sự cố |
| `NHAT_KY_THAO_TAC` | Nhật ký thao tác nhạy cảm | Chỉ ghi, không sửa không xoá (FR-SEC-07) |

## 6.6. Biểu đồ trạng thái (State Diagram)

### 6.6.1. Vòng đời hoá đơn

![Hình 6.13 — Biểu đồ trạng thái: vòng đời hoá đơn](diagrams/08-state-hoadon.png)

### 6.6.2. Vòng đời yêu cầu sửa chữa

![Hình 6.14 — Biểu đồ trạng thái: vòng đời yêu cầu sửa chữa](diagrams/09-state-succo.png)

---

# 7. XÁC MINH YÊU CẦU (REQUIREMENT VALIDATION)

## 7.1. Tiêu chí kiểm tra chất lượng yêu cầu
...
| **Đầy đủ** | Có nhóm chức năng nào trong danh sách sơ bộ (mục 3.7) chưa được đặc tả không? | Đạt — 10/10 nhóm đều có FR tương ứng |
...
## 7.2. Mâu thuẫn và nhập nhằng đã phát hiện
...
## 7.3. Ma trận truy vết yêu cầu (Traceability Matrix — trích)
...
| **Prototyping** | Dựng bản mẫu giao diện (wireframe) cho 3 màn hình khó nhất: ghi chỉ số, chi tiết hoá đơn, tổng quan nhiều toà — để kiểm chứng cách hiểu về luồng thao tác | Song song với mục 5 |
| **Kiểm thử bằng dữ liệu ví dụ** | Tự tính tay hoá đơn của 5 tình huống mẫu (ở giữa kỳ, thay công tơ, thu một phần, quyết toán cọc, điện bậc thang) rồi đối chiếu với đặc tả | Sau khi hoàn thành mục 5.4 |
...
Phiên bản **1.0** của tài liệu này, sau khi được giảng viên thông qua, trở thành **baseline**. Mọi thay đổi sau đó phải đi qua quy trình quản lý thay đổi ở mục 8.3.
...
## 8.3. Quy trình quản lý thay đổi
...
## Phụ lục A — Mẫu biên bản phỏng vấn

| Trường | Nội dung |
|---|---|
| Mã biên bản | PV-01 |
| Người được phỏng vấn | Họ tên — Vai trò — Đơn vị |
| Người phỏng vấn / ghi chép | |
| Thời gian, địa điểm | |
| Hình thức | Trực tiếp / Trực tuyến / Điện thoại |
| Mục tiêu buổi phỏng vấn | |
| **Nội dung trao đổi** | Ghi theo cặp Câu hỏi – Câu trả lời, giữ nguyên cách diễn đạt của người trả lời |
| **Phát hiện chính** | 3–5 gạch đầu dòng |
| **Yêu cầu rút ra** | Liệt kê kèm mã US/FR dự kiến |
| **Vấn đề cần làm rõ thêm** | |
| Người được phỏng vấn xác nhận | Ngày … Chữ ký … |

## Phụ lục B — Đề xuất công nghệ

Nhóm chưa chốt công nghệ. Dưới đây là ba phương án, kèm đánh giá theo năng lực của một nhóm 4 sinh viên năm 4 làm trong một học kỳ.

| Tiêu chí | **PA1 — Spring Boot + PostgreSQL + Thymeleaf/React** | **PA2 — ASP.NET Core + SQL Server + Razor/Blazor** | **PA3 — Node.js (NestJS) + PostgreSQL + Next.js** |
|---|---|---|---|
| Phù hợp chương trình học | Rất cao nếu nhóm đã học Java | Cao nếu nhóm đã học C# | Trung bình, cần tự học nhiều |
| Tài liệu tiếng Việt | Rất nhiều | Nhiều | Vừa |
| Tốc độ dựng CRUD | Nhanh (Spring Data JPA) | Rất nhanh (EF Core, scaffolding) | Nhanh (Prisma) |
| Xử lý nghiệp vụ tính tiền | Tốt, kiểu dữ liệu `BigDecimal` an toàn cho tiền tệ | Tốt, kiểu `decimal` | Cần thư viện riêng cho số thập phân — **rủi ro sai số tiền** |
| Triển khai miễn phí | Có (máy chủ ảo miễn phí hoặc container) | Có | Có, dễ nhất |
| Kết luận | **Khuyến nghị** nếu nhóm mạnh Java | Khuyến nghị nếu nhóm mạnh C# | Chỉ chọn khi cả nhóm đã quen JavaScript |

**Khuyến nghị chung, không phụ thuộc phương án**

| Hạng mục | Đề xuất | Lý do |
|---|---|---|
| Kiểu dữ liệu tiền tệ | `DECIMAL(15,2)`, tuyệt đối **không** dùng `float`/`double` | Tránh sai số làm lệch hoá đơn — lỗi kinh điển của đồ án quản lý thu chi |
| Múi giờ | Lưu `TIMESTAMP` theo UTC, hiển thị theo `Asia/Ho_Chi_Minh` | Tránh lệch ngày khi tính hạn thanh toán |
| Lưu ảnh | Lưu file ở kho đối tượng hoặc thư mục riêng ngoài thư mục công khai, chỉ phát qua liên kết có thời hạn | Yêu cầu NFR-SEC-04 |
| Giao diện | Ưu tiên thiết kế cho điện thoại trước (mobile-first) | Người quản lý thao tác chủ yếu trên điện thoại |
| Kiểm thử | Viết kiểm thử đơn vị cho **toàn bộ hàm tính tiền** trước khi làm giao diện | Đây là phần dễ sai và khó phát hiện bằng mắt |
| Dữ liệu mẫu | Chuẩn bị bộ dữ liệu 2 toà × 20 phòng × 6 kỳ ngay từ đầu | Không có dữ liệu thì không kiểm chứng được báo cáo và hiệu năng |

## Phụ lục C — Kế hoạch và phân công cho Bài 2 (2 tuần, nhóm 4 người)

**Tuần 1**

| Ngày | Công việc | Người phụ trách | Đầu ra |
|---|---|---|---|
| 1 | Thống nhất phạm vi, chốt danh sách stakeholder | Cả nhóm | Mục 1, 2 |
| 2 | Soạn bộ câu hỏi phỏng vấn và bảng hỏi | Thành viên 1 | Mục 3.2, 3.3 |
| 2–3 | Thu thập và phân tích tài liệu nghiệp vụ, quy định pháp luật | Thành viên 2 | Mục 3.5 |
| 3 | Đối sánh 3 sản phẩm cùng loại | Thành viên 2 | Mục 3.5.2 |
| 4–5 | Viết user story và tiêu chí chấp nhận | Thành viên 1 + 3 | Mục 4 |
| 5 | Rà soát chéo lần 1 | Cả nhóm | Danh sách chỗ cần sửa |

**Tuần 2**

| Ngày | Công việc | Người phụ trách | Đầu ra |
|---|---|---|---|
| 6–7 | Viết FR, NFR | Thành viên 3 | Mục 5.3, 5.5 |
| 6–7 | Viết quy tắc nghiệp vụ và ví dụ tính hoá đơn | Thành viên 1 | Mục 5.4 |
| 8–9 | Vẽ Use Case, Activity, DFD | Thành viên 4 | Mục 6.1–6.4 |
| 9–10 | Vẽ ERD, viết mô tả thực thể | Thành viên 4 | Mục 6.5 |
| 10 | Lập ma trận truy vết | Thành viên 3 | Mục 7.3 + Excel |
| 11 | Review chéo lần 2, xử lý mâu thuẫn | Cả nhóm | Mục 7.2 |
| 12 | Hoàn thiện định dạng, mục lục, nộp | Nhóm trưởng | Bản 1.0 |

**Nguyên tắc làm việc nhóm:** mỗi phần đều có **một người viết và một người review**; không ai tự review phần của chính mình.

## Phụ lục D — Rủi ro của dự án

| Mã | Rủi ro | Khả năng | Ảnh hưởng | Biện pháp giảm thiểu |
|---|---|---|---|---|
| R-01 | Phình phạm vi: ôm thêm thanh toán online, app di động, IoT | Cao | Cao | Đã ghi rõ danh sách Out of scope ở 1.3; mọi bổ sung phải đi qua quy trình CR ở 8.3 |
| R-02 | Không có dữ liệu người dùng thật, yêu cầu sai lệch so với thực tế | Cao | Trung bình | Ghi rõ giả định; bám sát tài liệu pháp quy và mẫu biểu có thật; sẵn sàng bộ câu hỏi để khảo sát khi có điều kiện |
| R-03 | Sai sót trong công thức tính tiền | Trung bình | Rất cao | Viết BR chi tiết kèm ví dụ số; bắt buộc kiểm thử đơn vị cho hàm tính tiền |
| R-04 | Biểu giá điện Nhà nước thay đổi trong thời gian làm đồ án | Trung bình | Thấp | Thiết kế biểu giá theo ngày hiệu lực, không viết cứng |
| R-05 | Thành viên nhóm lệch tiến độ, dồn việc cuối kỳ | Cao | Cao | Chia việc theo bảng ở Phụ lục C, có mốc review giữa chừng |
| R-06 | Không kịp làm hết chức năng đã đặc tả | Trung bình | Trung bình | Đã xếp ưu tiên MoSCoW; bảo vệ được sản phẩm nếu hoàn thành tập Must have |
| R-07 | Rò rỉ dữ liệu cá nhân (ảnh giấy tờ) trong bản demo | Thấp | Cao | Dùng dữ liệu giả trong demo; không tải ảnh giấy tờ thật lên hệ thống thử nghiệm |

## Phụ lục E — Đối chiếu với yêu cầu của Bài 2

| Yêu cầu trong đề bài | Mục tương ứng trong tài liệu | Trạng thái |
|---|---|---|
| Xác định những người liên quan đến dự án | Mục 2 (2.1 → 2.3) | Hoàn thành |
| Lập câu hỏi phỏng vấn / Bảng câu hỏi | Mục 3.2, 3.3 | Hoàn thành |
| Thu thập các tài liệu liên quan (quy định, mẫu biểu) | Mục 3.5 | Hoàn thành |
| Viết các user story và tiêu chí chấp nhận | Mục 4 (37 user story) | Hoàn thành |
| Đặc tả yêu cầu | Mục 5 (93 FR, 36 NFR, 22 BR) | Hoàn thành |
| Mô hình hoá yêu cầu (Use Case, Activity, DFD, ERD) | Mục 6 | Hoàn thành |
| *Bổ sung ngoài yêu cầu:* xác minh và quản lý yêu cầu | Mục 7, 8 | Hoàn thành |
