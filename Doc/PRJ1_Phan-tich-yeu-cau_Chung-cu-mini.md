...
**Mã dự án:** PRJ1-CCM
**Phiên bản:** 1.1
**Ngày lập:** 20/08/2026 · **Cập nhật:** 23/08/2026
...
| **1.1** | **23/08/2026** | **Nhóm** | **Áp dụng lô phiếu thay đổi số 01 (CR-001 → CR-015).** Đợt rà soát chéo giữa mô hình dữ liệu và quy tắc nghiệp vụ phát hiện 14 vấn đề, trong đó 10 vấn đề khiến quy tắc đã đặc tả không thực hiện được. Bổ sung CR-015 sau khi kiểm chứng lại văn bản pháp luật: cơ cấu biểu giá điện đã đổi từ 6 bậc sang **5 bậc**. Kèm theo: sửa ràng buộc C-02, đưa BR-15 về đúng thứ tự, chuẩn hoá danh mục tài liệu tham khảo, cập nhật ERD lên phiên bản 2 |
...
| R8 | Khảo sát 3 ứng dụng tương tự trên thị trường (xem mục 3.5.2). | Đối sánh tính năng, tránh bỏ sót yêu cầu |
...
>
> ⚠️ **Cần kiểm chứng lại trước khi nộp.** Giá bán lẻ điện bình quân được điều chỉnh theo chu kỳ khi chi phí đầu vào biến động. Nhóm cần tra lại trên trang chính thức của EVN hoặc Bộ Công Thương xem R3 còn hiệu lực hay đã có quyết định thay thế, và cập nhật cột đơn giá ở BR-02b cho khớp.

## 1.6. Bố cục tài liệu

Tài liệu gồm chín mục, đi theo trình tự của quy trình kỹ nghệ yêu cầu — từ việc xác định ai có tiếng nói, đến thu thập, đặc tả, mô hình hoá, rồi kiểm chứng lại những gì đã viết:

| Mục | Nội dung | Câu hỏi mà mục này trả lời |
|---|---|---|
| 1 | Giới thiệu | Bài toán là gì, làm cho ai, phạm vi tới đâu |
| 2 | Xác định các bên liên quan | Ai có tiếng nói với hệ thống, ai chịu ảnh hưởng |
| 3 | Thu thập yêu cầu | Yêu cầu đến từ đâu, thu thập bằng cách nào |
| 4 | User story | Người dùng muốn làm được gì, và thế nào là làm xong |
| 5 | Đặc tả yêu cầu phần mềm | Hệ thống **phải** làm gì, đo bằng cách nào, theo quy tắc nào |
| 6 | Mô hình hoá | Cấu trúc và hành vi của hệ thống trông ra sao |
| 7 | Xác minh yêu cầu | Bản đặc tả này có đủ tốt để đem đi lập trình không |
| 8 | Quản lý yêu cầu | Khi yêu cầu thay đổi thì xử lý thế nào |
| 9 | Phụ lục | Biểu mẫu, đề xuất công nghệ, kế hoạch, rủi ro, đối chiếu |

Hai mục dễ bị nhầm với nhau là **mục 7** và chương kiểm thử của báo cáo cuối kỳ. Mục 7 kiểm tra chất lượng của **bản đặc tả** — yêu cầu có rõ ràng không, có đo được không, có truy vết được không. Chương kiểm thử kiểm tra chất lượng của **phần mềm đã xây dựng**. Hai việc khác nhau, thực hiện ở hai giai đoạn khác nhau.
...
![Hình 6.12 — Biểu đồ thực thể quan hệ (ERD), phiên bản 2](diagrams-v2/07-erd-v2.png)
...
| Đặc tả yêu cầu | Mục 5 (93 FR, 36 NFR, 23 BR) | Hoàn thành |
